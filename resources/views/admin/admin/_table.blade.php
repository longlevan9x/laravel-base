@php /** @var \App\Models\Admins $model*/ @endphp
<tr class="text-center">
    ...
    <td class="vertical-middle">{{$model->getRoles()->get(0)}}</td>
    ...
    <td class="col-lg-2 col-md-2 col-sm-2 col-xs-2 vertical-middle">
        @include('admin.layouts.widget.button.button_link.action-text', ['url' => \App\Http\Controllers\Admin\AdminController::getUrlAdmin($model->id), 'showEdit' => can_edit('admin'), 'showDelete' => can_destroy('admin'), 'showView' => can_show('admin')])
    </td>
</tr>