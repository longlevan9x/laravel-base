...
<div class="table-responsive">
    <table class="table table-hover">
        ...
        <tr>
            <td>@lang('abilities.role.name')</td>
    ...
    @can(ability_edit('admin'))
        <div class="pull-left">
            @include('admin.layouts.widget.button.button_link.edit', ['url' => \App\Http\Controllers\Admin\AdminController::getConfigUrlAdmin($model->id, 'edit'), 'text' => __('abilities.title.update')])
        </div>
    @endcan
    @can(ability_destroy('admin'))
        {{Form::open([
	        'url' => \App\Http\Controllers\Admin\AdminController::getUrlAdmin($model->id),
            'method' => 'delete'
        ])}}
        @include('admin.layouts.widget.button.button_link.delete', ['url' => \App\Http\Controllers\Admin\AdminController::getUrlAdmin($model->id), 'text' => __('abilities.title.destroy')])
        {{Form::close()}}
    @endcan
</div>
