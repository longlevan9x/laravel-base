            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="error wow bounceIn" data-wow-delay="300ms">
                        <h1>{{ isset($exception) ? $exception->getStatusCode() : (isset($errorCode) ? $errorCode : 404) }}</h1>
                    </div>
                    ...
                    <a href="{{url('/')}}" class="btn_common blue border_radius wow fadeIn btn btn-primary" data-wow-delay="100ms">@lang('website.home page')</a>
